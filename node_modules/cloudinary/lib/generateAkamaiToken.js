...
(function() {
  ...
  module.exports = generateAkamaiToken = function(options) {
    var auth, expiration, key, ref, ref1, ref2, start, tokenName, tokenParts;
    key = (ref = options.key) != null ? ref : config().akamai_key;
    tokenName = (ref1 = options.token_name) != null ? ref1 : "__cld_token__";
    expiration = options.end_time;
    if (expiration == null) {
      if (options.window != null) {
        start = (ref2 = options.start_time) != null ? ref2 : Math.round(Date.now() / 1000);
